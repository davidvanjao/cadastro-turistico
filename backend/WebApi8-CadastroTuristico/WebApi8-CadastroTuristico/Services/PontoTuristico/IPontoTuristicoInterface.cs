...
namespace WebApi8_CadastroTuristico.Services.PontoTuristico {
    public interface IPontoTuristicoInterface {
        ...
        //Task metodo asincrono, tipo de retorno reponseModel, tipo List retorna lista de Ponto turistico Model
        ...
        Task<ResponseModel<List<PontoTuristicoModel>>> BuscarPontoTuristicoFiltroAvancado(string termoBusca);
